...
eşkenar mı yoksa sıradan bir üçgen mi olduğunu bulmaya çalışın. Eğer verilen kenarlar
bir üçgen belirtmiyorsa, ekrana "Üçgen belirtmiyor" şeklinde bir yazı yazın.o
...
"""
şekil = input("Hangi geometrik şekil tipini bulmak istiyorsunuz?")
